    ...
    <v-container>
      ...
      <v-card class="my-2 bg-white" variant="outlined">
        ...
        <v-card-text>
          <v-row align="center">
            <v-col cols="12" md="3">
              <v-text-field v-model="firstname" :rules="nameRules" :counter="10" label="Prénom du pratiquant*" variant="outlined" required class="bg-white"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-text-field v-model="lastname" :rules="nameRules" :counter="10" label="Nom du pratiquant*" variant="outlined" required class="bg-white"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-text-field v-model="birthdate" type="date" :rules="emailRules" label="Date de naissance*" variant="outlined" required class="bg-white"></v-text-field>
            </v-col>
            <v-col cols="12" md="3">
              <v-radio-group v-model="sex" label="Sexe">
                <v-radio label="Masculin" value="M" class="bg-white"></v-radio>
                <v-radio label="Feminin" value="F" class="bg-white"></v-radio>
              </v-radio-group>
            </v-col>
            <v-col cols="6" md="3">
            ...
            <v-col cols="6" md="2">
              <v-text-field v-model="postalCode" label="Code postal*" :rules="postalCodeRules" required variant="outlined" class="bg-white"></v-text-field>
            </v-col>
            <v-col cols="6">
              <v-text-field v-model="city" label="Ville*" :rules="cityRules" required variant="outlined" class="bg-white"></v-text-field>
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="6" md="2">
            ...
            <v-col cols="12">
              <v-text-field v-model="email" :rules="emailRules" label="Adresse email*" variant="outlined" required class="bg-white"></v-text-field>
            </v-col>
          </v-row>
        </v-card-text>
      </v-card>
      <v-card class="my-2 bg-white" variant="outlined">
        ...
        <v-card-text>
          ...
          <v-row>
            <v-col cols="12" md="6">
              <v-text-field v-model="ista" label="N° ISTA" variant="outlined" class="bg-white"></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
              <v-text-field v-model="previousDojo" label="Ancien Dojo et nom du professeur" variant="outlined" class="bg-white"></v-text-field>
            </v-col>
          </v-row>
        </v-card-text>
      </v-card>
      <v-card class="my-2 bg-white" variant="outlined">
        ...
        <v-card-text>
          <v-row>
            <v-col>
              <v-text-field v-model="hospital" label="Etablissement médical préféré" hint="Hôpital ou clinique à privilégier en cas d'urgence" variant="outlined" class="bg-white"></v-text-field>
            </v-col>
            <v-col>
              <v-text-field v-model="hospital" label="Antécédents médicaux" hint="Information a communiquer en cas d'urgence" variant="outlined" class="bg-white"></v-text-field>
            </v-col>
          </v-row>
        </v-card-text>
      </v-card>
